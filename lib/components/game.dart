...
import 'package:game_ex/components/background.dart';
import 'package:game_ex/components/brick.dart';
import 'package:game_ex/components/enemy.dart';
import 'package:game_ex/components/ground.dart';
import 'package:game_ex/components/player.dart';
...
class MyPhysicsGame extends Forge2DGame {
  ...
  final _random = Random(100); // Add from here
    ...
    for (var i = 0; i < 5; i++) {
      ...
      await world.add(
        Brick(
          ...
          position: Vector2(
              camera.visibleWorldRect.right / 2 +
                  (_random.nextDouble() * 10 - 2.5),
              -30),
